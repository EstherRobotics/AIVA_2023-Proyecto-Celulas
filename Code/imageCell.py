...
class ImageCell:
    ...
    def predictCells(self):
        """Realiza la predicción de las células sobre la imagen"""
    ...
    def drawBoundingBox(self, out):
        ...
        for i, (x0, y0, x1, y1, score, cls_id) in enumerate(out[0]):
            ...
            name = 'cell ' + str(score)
            cv2.putText(img_aux, name, (box[0], box[1] - 2), cv2.FONT_HERSHEY_SIMPLEX, 0.75, [225, 255, 255],
                        thickness=2)
